...
import { Divider, Footer, ProductCard } from "../";
import { foryouData } from "../../data";
const ProductDetailForYou = () => {
  ...
  const selectedProduct = foryouData[selectedProductIndex];
  ...
  return (
    <ScrollView style={{ backgroundColor: "#FFFFFF" }}>
      ...
      <View style={{ padding: 20, marginTop: 20 }}>
        ...
        {/* Related Products */}
        <View
          style={{ flexDirection: "row", justifyContent: "center", gap: 25 }}
        >
          <View>
            <Image
...
export default ProductDetailForYou;
